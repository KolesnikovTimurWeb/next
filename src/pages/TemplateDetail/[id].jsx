      ...
      >
                ...
                result.exs_type === exsTypeId
                  ? result.exercises.map((ex) => (
                    <Select.Option key={ex.index} value={ex}>
                      <p onMouseEnter={() => setDropDown(true)} onClick={() => setMusleFun(false)}>
            ...
            {dropDown &&
              <Select.Option >
                <p onClick={() => setMusleFun(true)}>
                  <span>Добавить свое yпражнение </span>
                </p>
              </Select.Option>
            }
            {exsTypeId === "" ? (
        ...
        {musleFunc === true ? (
          <input
            ...
            value={musle}
            onChange={(e) => {
              handleSelectChangeEx(e.target.value), setExerciseName(e.target.value), setMusle(e.target.value);
            }}
          />
        ) : ' '}
